...
<head>
    ...
    <title>SPK Pemilihan Calon Manager Metode AHP</title>
    <!-- Bootstrap Core CSS -->
        ...
        <header class="topbar">
            <nav class="navbar top-navbar navbar-toggleable-sm navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="<?= base_url() ?>" style="font-size: 2rem">
                        <!-- Logo icon --><b>
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="<?= $this->session->userdata('role') == "Admin" ? base_url('public/assets/images/users/user.png') : base_url('public/assets/images/users/user2.png') ?>" alt="user" class="profile-pic m-r-10" /><?= $this->session->userdata('nama_lengkap') ?></a>
                        </li>
                    </ul>
                </div>
            </nav>
