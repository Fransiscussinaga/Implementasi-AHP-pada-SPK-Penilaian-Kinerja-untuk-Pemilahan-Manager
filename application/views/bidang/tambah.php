            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-block">
                        <h4 class="card-title">Tambah Bidang Pekerjaan</h4>
                        <?= form_open('bidang/tambah', 'class="form-horizontal form-material"') ?>
                        <?= $this->session->flashdata('success') ?>
                        <div class="form-group">
                            <label class="col-md-12">Bidang Pekerjaan</label>
                            <div class="col-md-12">
                                <input type="text" name="bidang_pekerjaan" class="form-control form-control-line" value="<?= set_value('bidang_pekerjaan') ?>">
