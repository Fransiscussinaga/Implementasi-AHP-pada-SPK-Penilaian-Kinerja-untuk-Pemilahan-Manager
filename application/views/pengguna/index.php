                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($row->username != "admin") : ?>
                                                    <a href="<?= site_url('pengguna/ubah/' . $row->id_admin) ?>" class="btn btn-success btn-xs" title="Ubah">Ubah</a>
                                                    <a href="#" data-href="<?php echo site_url('pengguna/hapus/' . $row->id_admin); ?>" data-toggle="modal" data-target="#confirm-delete" class="btn btn-danger btn-xs" title="Hapus">Hapus</a>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
