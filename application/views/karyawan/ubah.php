                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" name="nik" class="form-control form-control-line" value="<?= set_value('nik', $karyawan->nik) ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" name="nama_karyawan" class="form-control form-control-line" value="<?= set_value('nama_karyawan', $karyawan->nama_karyawan) ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" name="pendidikan_terakhir" class="form-control form-control-line" value="<?= set_value('pendidikan_terakhir', $karyawan->pendidikan_terakhir) ?>">
