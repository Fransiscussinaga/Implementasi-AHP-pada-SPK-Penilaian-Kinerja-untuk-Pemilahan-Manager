                                        ...
                                        foreach ($karyawan as $row_karyawan) : ?>
                                            <tr>
                                                ...
                                                <?php foreach ($kriteria as $row_kriteria) : ?>
                                                    <td class="text-center"><?= $nilai[$row_karyawan->id_karyawan][$row_kriteria->id_kriteria] ?></td>
                                                <?php endforeach; ?>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($karyawan as $row_karyawan) : ?>
                                            <tr>
                                                ...
                                                <td><?= $row_karyawan->nama_karyawan ?></td>
                                                <?php foreach ($kriteria as $row_kriteria) : ?>
                                                    <td class="text-center"><?= $nilai_ahp[$row_karyawan->id_karyawan][$row_kriteria->id_kriteria] ?></td>
                                                <?php endforeach; ?>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                ?>
                                                    <td class="text-center"><?= $nilai_prioritas[$row_karyawan->id_karyawan][$row_kriteria->id_kriteria] ?></td>
                                                <?php endforeach; ?>
