            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-block">
                        <h4 class="card-title">Tambah Periode Penilaian</h4>
                        <?= form_open('periode/tambah', 'class="form-horizontal form-material"') ?>
                        <?= $this->session->flashdata('success') ?>
                        <div class="form-group">
                            <label class="col-md-12">Periode Penilaian</label>
                            <div class="col-md-12">
                                <input type="text" name="periode_penilaian" class="form-control form-control-line" value="<?= set_value('periode_penilaian') ?>">
